...
def myNetwork():
    ...
    ap2 = net.addAccessPoint('ap2', cls=OVSKernelAP, ssid='ap2-ssid', channel='1', mode='g', position='-35,-35,0', range=65)
    ...
    # IS DESTROYED #ap6 = net.addAccessPoint('ap6', cls=OVSKernelAP, ssid='ap6-ssid', channel='1', mode='g', position='-60,-75,0', range=30)
    ap7 = net.addAccessPoint('ap7', cls=OVSKernelAP, ssid='ap7-ssid', channel='1', mode='g', position='-131,-45,0', range=65)
    ...
    net.addLink(h5, sta5)
    #
    # IS DESTROYED #net.addLink(sta6, ap6)
    net.addLink(h6, sta2)
    net.addLink(h8, sta2)
    net.addLink(h9, sta2)
    net.addLink(h10, sta2)
    net.addLink(h11, sta7)
    net.addLink(h12, sta7)
    net.addLink(h13, sta7)
    net.addLink(h14, sta7)
    net.addLink(h15, sta7)
    net.addLink(h16, sta7)
    #
    ...
    net.get('ap4').start([])
    net.get('ap5').start([])
    # IS DESTROYED #net.get('ap6').start([])
    net.get('ap7').start([])
